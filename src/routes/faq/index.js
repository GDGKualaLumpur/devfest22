...
export default class Faq extends Component {
	...
	componentDidMount() {
		document.title = 'FAQ - DevFest 2022 Kuala Lumpur';
				...
				<div class={style.faq}>
					<div class={style.faq_item}>
						...
						<div class={style.faq_content}>
							...
							<p>DevFest 2022 Kuala Lumpur will take place on the 3rd December 2022 at Sunway University.</p>
							<br />
							<p><b>Stay Informed</b></p>
							<p>To stay up to date on the latest information on sessions, speakers, and activities, be sure to visit the DevFest 2022 Kuala Lumpur website, and follow us on <a href="https://www.facebook.com/GDGKualaLumpur/" target="_blank" rel="noopener noreferrer">Facebook Page</a>. You can also follow and join the social conversation about DevFest 2022 Kuala Lumpur via official hashtags <b>#devfestkl22</b>. In addition, we'll be emailing important information to all registered attendees, along with check-in instructions prior to the conference.</p>
							<br />
							...
							<br />
							<p><b>Language</b></p>
							<p>All presentations at DevFest 2022 Kuala Lumpur will be in English.</p>
						</div>
					</div>
				</div>
				<div class={style.faq}>
					<div class={style.faq_item}>
						...
						<div class={style.faq_content}>
							...
							<p>Attendees can connect to the WiFi network.</p>
							<br />
							<p><b>Washroom</b></p>
					...
					<div class={style.faq_item}>
						...
						<div class={style.faq_content}>
							...
							<ul>
								...
								<li>By registering and accepting any discounts, gifts, or items of value related to DevFest 2022 Kuala Lumpur, you certify that you are able to do so in compliance with applicable laws and the internal rules of your organization.</li>
								...
								<li>Attendees aren’t permitted to bring guests to DevFest 2022 Kuala Lumpur. If you have someone traveling with you, they’ll need to register themselves and purchase an attendee ticket.</li>
								<li>Photographs and/or video taken at DevFest 2022 Kuala Lumpur by GDG Kuala Lumpur, or others on behalf of GDG Kuala Lumpur, may include your image or likeness. You agree that GDG Kuala Lumpur may use such photographs and/or video for any purpose without compensation to you.</li>
								...
								<li>You agree to be solely responsible for your own safety, belongings, and well-being while participating in DevFest 2022 Kuala Lumpur. GDG Kuala Lumpur won't be liable for your participation in DevFest 2022 Kuala Lumpur.</li>
								<li>No solicitation or selling of items or services is allowed at DevFest 2022 Kuala Lumpur. Any attendee conducting these activities may be removed from the conference.</li>
							</ul>
						</div>
					</div>
				</div>
				<div class={style.faq}>
					<div class={style.faq_item}>
						...
						<div class={style.faq_content}>
							...
							<p>DevFest 2022 Kuala Lumpur is a developer event, so please be comfortable and casual. There is no enforced dress code.</p>
							<br />
							...
							<p>No solicitation or selling of items or services is allowed at DevFest 2022 Kuala Lumpur. Any attendee conducting these activities may be removed from the conference.</p>
							<br />
							<p><b>Community Guidelines</b></p>
